        ...
        <div className="d-table pt-80">
          <div className="d-table-cell ">
            <div className="container">
              <h1>Commercial Electrician Services</h1>
              <p>
                OW London, Electrician, and Smart Home Engineers provide comprehensive commercial electrical services across London. Our 2-hour emergency response for businesses is available 24/7, ensuring minimal disruption to your operations.
              </p>
              <CallUsNowButton/>
            </div>
          </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 services-details">
              <div className="services-details-desc">
                <h3>Exceptional Commercial Electrical Services</h3>
                <p>
                  Compliance with electrical laws and regulations is critical for businesses. Incorrectly installed wiring or equipment not only poses a danger to employees but can also invalidate your insurance.
                </p>
                <p>
                  Our experienced commercial electrical contractors ensure safety and compliance with the latest regulations. We offer everything from minor repairs to complete electrical system design and rewire.
                </p>
                <p>
                  Whether you need electrical installation, maintenance, or emergency repairs, our qualified team is ready to help. We understand the unique needs of commercial properties and provide bespoke solutions.
                </p>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 services-details">
              <div className="services-details-desc">
                ...
                <p>
                  Our services include electrical contracting, project design, installation, maintenance, and inspection. We handle commercial office fit-outs, education, healthcare, and new build residential projects.
                </p>
                <p>
                ...
                <div className="services-details-accordion">
                  <Accordion preExpanded={["a"]}>
                    <AccordionItem uuid="a">
                      <AccordionItemHeading>
                        <AccordionItemButton>
                          <span>What commercial electrical services do you offer?</span>
                        </AccordionItemButton>
                      </AccordionItemHeading>
                      <AccordionItemPanel>
                        <p>
              ...
              <p>
                For all your commercial electrical needs, call us on +44 7307 565 444 or email at info@owresearch.netlify.app. We are always happy to assist with your projects and electrical problems.
              </p>
        </div>
      </div>
    </>
...
export default CommercialElectrician;
