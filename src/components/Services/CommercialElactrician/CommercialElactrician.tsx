        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 services-details">
              ...
              <p>
                For all your commercial electrical needs, call us on +44 7307 565 444 or email at info@owelectric.co.uk. We are always happy to assist with your projects and electrical problems.
              </p>
        </div>
      </div>
    </>
