        ...
        <div className="col-12">
          <div className="card mb-3">
            <div className="card-body">
              ...
              <p className="card-text"><a href="/contact"><FaMapMarkedAlt /> Contact us</a> for more information. Check our <a href="/courses">pricing</a> and read our <a href="/about/gallery">reviews</a> to see what our clients have to say.</p>
            </div>
          </div>
        </div>
      </div>
