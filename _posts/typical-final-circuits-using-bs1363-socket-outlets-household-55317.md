---
title: "Understanding Typical Final Circuits Using BS 1363 Socket-Outlets in Household Installations"
excerpt: "Regulation 553.1.7 outlines the guidelines for the number and positioning of socket-outlets in household installations. Learn how diversity is applied and the requirements for conductor sizes as per BS 7671."
...
tags: [Electrical Safety, Wiring Regulations, BS 7671, Compliance, Socket-Outlets, Final Circuits, Household Installations, BS 1363, Ring Circuit, Radial Circuit]
keywords: [Electrician London, Home Automation London, Electrician Near Me, Certified Electrical Compliance, Guide Note 3, Inspection and Testing, BS 1363 socket, Ring Final Circuit, Radial Circuit, Overcurrent Protection]
categories: [Electrical Engineering, Home Automation, Safety Compliance]
coverImage: "/images/typical-final-circuits-using-bs1363-socket-outlets-household-installations-regulation-55317.webp"
miniImage: "/images/typical-final-circuits-using-bs1363-socket-outlets-household-installations-regulation-55317.webp"
ogImage:
...
faq: 
  - question: What is the maximum number of socket-outlets allowed on a ring final circuit?
    answer: According to Regulation 553.1.7, there is no specific maximum number of socket-outlets, but they must be positioned to ensure compliance with the regulation. Each socket-outlet in a twin or multiple socket-outlet unit is considered as one socket-outlet.
  - question: How is diversity applied to socket-outlets in household installations?
    answer: Regulation 553.1.7 states that diversity between socket-outlets and permanently connected equipment has already been considered in Table C1, so no further diversity may be applied.
  - question: What is the minimum conductor size for a radial circuit protected by a 20 A overcurrent device?
    answer: As per Table C1 and in accordance with Regulation 553.1.7, the minimum conductor size for a radial circuit with a 20 A protective device is 2.5 mm² copper conductor thermoplastic or thermosetting insulated cables, or 1.5 mm² copper conductor mineral insulated cables.
  - question: Can 1.5 mm² mineral insulated cable (MICC) be used in a ring final circuit?
    answer: Yes, according to the additional notes in Table C1 and Regulation 553.1.7, 1.5 mm² two-core MICC can be used for a ring final circuit with a protective device rated at not more than 32 A, provided the conductor does not operate at a temperature above 70 °C.
  - question: What installation methods apply to the conductor sizes listed in Table C1?
    answer: The values in Table C1 apply to thermoplastic or thermosetting insulated cables identified in Table 4A2 of Appendix 4, installed using installation methods C and B, and to mineral insulated cable (MICC) identified in Table 4G1A, installed according to reference methods C, E, F, and G.
